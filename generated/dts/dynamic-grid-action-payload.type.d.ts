...
type IDynamicGridActionPayload = {
    /**
    ...
    context: {
         ...
         *
         * For example, it can be the `SubmitEvent` on a [Form] or `ClickEvent` on [Button]
         */
        ev?: Event;
        /**
         * Argument of the action
         *
         * This can be used to pass arguments to the action when the action is triggered
         */
        argument?: IItem;
        /**
         * The building block that triggered the action
         */
        item?: DynamicGridItem;
        /**
         * The list item that triggered the action
         *
         * This property is only available in building blocks that support list-like items
         * for example the `list` building block
         */
        listItem?: Record<string, any>;
        /**
         * When the action is triggered within a container (= `gridbox`, `flexbox`, `area`),
         * the `containerData` will be populated with the data from all the items within the container
         */
