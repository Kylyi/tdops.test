...
export default extendUtilitiesConfig({
  ...
  dataTypeExtend: {
    ...
    inputByDataType: {
      ...
      intSimple: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: {}, icon: 'i-lsicon:number-filled' },
      long: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: {}, icon: 'i-tabler:decimal' },
      longSimple: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: {}, icon: 'i-tabler:decimal' },
      double: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: {}, icon: 'i-tabler:decimal' },
      doubleSimple: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: {}, icon: 'i-tabler:decimal' },
      DateTime: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/DateInput/DateInput.vue`)), props: {}, icon: 'i-system-uicons:calendar-date' },
      DateTimeSimple: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/DateInput/DateInput.vue`)), props: {}, icon: 'i-system-uicons:calendar-date' },
      array: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Selector/Selector.vue`)), props: { multi: true }, icon: 'i-material-symbols:data-array-rounded' },
      decimal: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: { decimal: true, precision: 4 }, icon: 'i-tabler:decimal' },
      decimalSimple: { component: defineAsyncComponent(() => import(`${uiPath}/client/components/Inputs/NumberInput/NumberInput.vue`)), props: { decimal: true, precision: 4 }, icon: 'i-tabler:decimal' },
    },
